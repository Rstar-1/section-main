...
const EditSuccess = ({ title, description }) => {
  const refreshPage = () => {
    window.location.reload(true);
  };
  return (
    <div className="pop-w">
      <div className="p30 rounded-10 bgwhite b-shadow">
        ...
        <div className="text-center">
          <h6 className="fsize21 font-500 mtpx1 mbpx1 textdark">
            {title.length > 0 ? title : "Success"}
          </h6>
