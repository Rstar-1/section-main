...
const EditCms2 = (props) => {
  ...
  // API
  useEffect(() => {
    console.log(props.editshow2, "dfs");
    setFormData({
      sectionid: props.editshow2.sectionid,
      sectionname: props.editshow2.sectionname,
      cmsdata: props.editshow2.cmsdata,
      imagePreviewUrl: props.editshow2.cmsdata,
    });
  }, [props.editshow2]);
  // API
