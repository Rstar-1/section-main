...
import { addmanagement } from "../../../../../../../../redux/automateredux/ManagementSlice";
...
const AddManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const resultAction = await dispatch(addmanagement(formToSubmit));

    if (addmanagement.fulfilled.match(resultAction)) {
      setsuccess(true);
      setFormData({
        sectionpath: "",
        sectionname: "",
