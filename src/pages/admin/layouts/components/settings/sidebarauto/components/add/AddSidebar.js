...
import { addsidebar } from "../../../../../../../../redux/automateredux/SidebarSlice";
...
const AddSidebar = () => {
  ...
  const { loading, error } = useSelector((state) => state.sidebardata);
  // Redux State
  ...
  const handleSubmit = async (e) => {
    ...
    const resultAction = await dispatch(addsidebar(formToSubmit));

    if (addsidebar.fulfilled.match(resultAction)) {
       setsuccess(true);
      setFormData({
        sectionpath: "",
        sectionname: "",
